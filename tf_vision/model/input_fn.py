...
def input_fn(is_training, filenames, labels, params):
    ...
    # https://stackoverflow.com/a/3252425/8037585
    # parse_fn = lambda f, l: _parse_function(f, l, params.image_size)
    # train_fn = lambda f, l: train_preprocess(f, l, params.use_random_flip)
    parse_fn = functools.partial(_parse_function, size=params.image_size)
    train_fn = functools.partial(train_preprocess, use_random_flip=params.image_size)
